...
// Injected by Vite's `define` config — reliably available in both the client
// and SSR (Nitro) bundles because Vite replaces it before Nitro bundles.
declare const __GH_PAGES_BASE__: string;

export const getRouter = () => {
    const router = createRouter({
          routeTree,
          context: {},
          basepath: __GH_PAGES_BASE__,
